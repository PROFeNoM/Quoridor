...
toto : src/graph_pattern.c src/server.c src/player.c src/annex_function.c
	...
	cc -shared -fPIC src/player.c src/annex_function.c -o install/libplayer_1.so
	cc -shared -fPIC src/player_bis.c src/annex_function.c -o install/libplayer_2.so
